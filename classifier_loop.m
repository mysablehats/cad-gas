    ...
    for NODES = simvar.NODES_VECT
        for MAX_EPOCHS = simvar.MAX_EPOCHS_VECT
            for featuress = 1:simvar.featuresall
                ...
                for valaction = simvar.Alldata %% iterate over different validation data
                    if strcmp(simvar.validationtype,'type2')||strcmp(simvar.validationtype,'type2notrandom')||strcmp(simvar.validationtype,'type2all')
                        ...
                        simvar.TrainSubjectIndexes = setdiff(simvar.AllSubjects,[simvar.ValSubjectIndexes]);
                    else
                    ...
                    %% Loading data
                    data = makess(simvar.numlayers); % I need to know the length of architectures...
