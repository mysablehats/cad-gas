...
allconn_set = {...
    ...
    {...%%%% ARCHITECTURE 20
    {'knn1layer',   'knn',{'pos'},                    'pos',[1 11],parsk(1),'knn',parsc(1),'nodes'}...
    {'knn1layer',   'knn',{'pos'},                    'pos',[1 12],parsk(1),'knn',parsc(1),'nodes'}...
    {'knn1layer',   'knn',{'pos'},                    'pos',[1 13],parsk(1),'knn',parsc(1),'nodes'}...
    {'knn1layer',   'knn',{'pos'},                    'pos',[1 14],parsk(1),'knn',parsc(1),'nodes'}...
    {'knn1layer',   'knn',{'pos'},                    'pos',[1 15],parsk(1),'knn',parsc(1),'nodes'}...
    {'knn1layer',   'knn',{'pos'},                    'pos',[1 16],parsk(1),'knn',parsc(1),'nodes'}...
    {'knn1layer',   'knn',{'pos'},                    'pos',[1 17],parsk(1),'knn',parsc(1),'nodes'}...
    {'knn1layer',   'knn',{'pos'},                    'pos',[1 18],parsk(1),'knn',parsc(1),'nodes'}...
    {'knn1layer',   'knn',{'pos'},                    'pos',[1 19],parsk(1),'knn',parsc(1),'nodes'}...
    {'knn1layer',   'knn',{'pos'},                    'pos',[1 21],parsk(1),'knn',parsc(1),'nodes'}...
    }...
    {...%%%% ARCHITECTURE 21
    {'knn1layer',   'knn',{'pos'},                    'pos',[useroptions.w ceil((useroptions.w)/2)],parsk(1),'knn',parsc(1),'nodes'}...
    }...
    {...%%%% ARCHITECTURE 22
